...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(all_success_df, values='class', names='Launch Site', 
...
def get_scatter_chart(entered_site, selected_range):
    range_df = spacex_df[ (spacex_df['Payload Mass (kg)']>=selected_range[0]) & 
    ...
    if entered_site == 'ALL':
        ...
        fig=px.scatter(site_range_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
